  ...
  const fetchProducts = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from('products')
        .select('id, name, description, category, base_price, discount_price, discount_start_date, discount_end_date, discount_active, purity_percentage, molecular_weight, cas_number, sequence, storage_conditions, stock_quantity, available, featured, image_url, safety_sheet_url, inclusions, created_at, updated_at')
        .eq('available', true)
